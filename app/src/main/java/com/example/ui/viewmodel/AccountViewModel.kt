...
data class AccountUiState(
    ...
    val allExpenses: List<com.example.domain.model.Expense>,
...
class AccountViewModel(
    ...
    fun updateDisplayName(newName: String) {
        viewModelScope.launch {
            ...
            val currentUser = authRepository.currentUser
            if (currentUser != null) {
                userRepository.updateUser(com.example.domain.model.User(currentUser.uid, newName, currentUser.email ?: ""))
            }
            retryTrigger.value++
        }
    }
